...
Efectos data-driven por familias implementadas: boost10 (ataque/defensa), attribute_freeze, paralyze, power_increase, zap, NWO globales, assassination, disaster, goal, recursos genéricos (power_bonus, defense_bonus, extra_token, draw_bonus, immunity_vs). Cartas con efecto único no implementado: jugables como "Plot genérico" (muestra texto, luego descarte). Flag implemented:true/false en cada carta.
